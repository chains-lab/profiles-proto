...
func (x *SearchProfileRequest) Reset() {
	*x = SearchProfileRequest{}
	mi := &file_profile_user_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SearchProfileRequest) Descriptor() ([]byte, []int) {
	return file_profile_user_proto_rawDescGZIP(), []int{2}
}
...
func (x *UpdateOwnProfileRequest) Reset() {
	*x = UpdateOwnProfileRequest{}
	mi := &file_profile_user_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateOwnProfileRequest) Descriptor() ([]byte, []int) {
	return file_profile_user_proto_rawDescGZIP(), []int{3}
}
...
func (x *UpdateOwnUsernameRequest) Reset() {
	*x = UpdateOwnUsernameRequest{}
	mi := &file_profile_user_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateOwnUsernameRequest) Descriptor() ([]byte, []int) {
	return file_profile_user_proto_rawDescGZIP(), []int{4}
}
...
const file_profile_user_proto_rawDesc = "" +
	"\n" +
	"\x12profile_user.proto\x12\aprofile\x1a\x15profile_structs.proto\x1a\x1bgoogle/protobuf/empty.proto\"\x94\x02\n" +
	...
	"\busername\x18\x01 \x01(\tR\busername2\xdb\x02\n" +
	"\vUserService\x12C\n" +
...
var (
	...
	file_profile_user_proto_rawDescData []byte
)

func file_profile_user_proto_rawDescGZIP() []byte {
	file_profile_user_proto_rawDescOnce.Do(func() {
		file_profile_user_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_profile_user_proto_rawDesc), len(file_profile_user_proto_rawDesc)))
	})
	return file_profile_user_proto_rawDescData
}

var file_profile_user_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_profile_user_proto_goTypes = []any{
...
func file_profile_user_proto_init() {
	...
	file_profile_user_proto_msgTypes[0].OneofWrappers = []any{}
	file_profile_user_proto_msgTypes[1].OneofWrappers = []any{
		(*GetProfileRequest_UserId)(nil),
		(*GetProfileRequest_Username)(nil),
	}
	file_profile_user_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_profile_user_proto_rawDesc), len(file_profile_user_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
